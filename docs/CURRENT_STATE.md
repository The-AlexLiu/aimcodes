...
当前分支将五语种产品界面与 SEO 索引范围拆开：英语、日语作为增长语言，西语与葡语进入维护，中文保留完整产品界面但仅首页、准星库与反应测试允许索引。Meme 近义集合将永久重定向至 Funny；职业选手资料库和职业聚合页将重定向至准星库，具体选手准星代码页继续服务预览与复制但不再显示人物资料。新增 SEO 范围报告、搜索意图门、构建提交标识和按变更范围运行 CI/IndexNow 的规则。本地构建继续生成 3,145 个可访问页面，主 Sitemap 收缩为 1,887 个 URL，准星 Sitemap 为 1,584 个 URL，图片 Sitemap 覆盖 1,736 个页面和 3,320 个图片引用。本节为本地待发布状态，尚未影响生产站。
