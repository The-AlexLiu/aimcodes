...
| SEO/localization | `docs/SEO_OPERATING_POLICY.md`, `docs/SEO_STRATEGY.md`, route and content modules | `check:seo` | Intent gate, canonical, index control, locale tier |
