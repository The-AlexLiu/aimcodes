...
Require targeted validators, semantic review, five-language product UI checks, SEO locale-tier checks, and browser QA for public changes. Escalate to high risk if several scopes change together.
