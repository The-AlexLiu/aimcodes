...
const uiCopy = {
  en: {
    map: 'Map scene', code: 'Crosshair code', paste: 'Paste a profile code', valid: 'Code looks good—ready to try', invalid: 'This code cannot be read. Check whether a section is missing.', copy: 'Copy code', left: 'Left crosshair', right: 'Right crosshair', settings: 'Shape the crosshair', color: 'Color', outline: 'Outline', centerDot: 'Center dot', inner: 'Inner lines', outer: 'Outer lines', opacity: 'Opacity', length: 'Length', thickness: 'Thickness', offset: 'Offset', size: 'Size', movement: 'Movement error', firing: 'Firing error', preview: 'Map preview', decoded: 'What the code contains', on: 'On', off: 'Off', generatorNote: 'The code is checked once more before you copy it.', comparisonNote: 'Same map, same scale. Your eyes can judge the shape without the background getting in the way.', codeHelp: 'Paste the whole string—do not miss the beginning, ending, or separators.', finder: 'Still not sure?', finderAction: 'Let the crosshair finder pick one', faq: 'Common questions',
  ...
  'zh-CN': {
    map: '试用地图', code: '准星代码', paste: '把整段准星代码贴进来', valid: '代码没问题，直接试', invalid: '这串代码读不出来，检查有没有漏掉一段。', copy: '复制代码', left: '左边准星', right: '右边准星', settings: '怎么长，你来调', color: '准星颜色', outline: '轮廓', centerDot: '中心点', inner: '内线', outer: '外线', opacity: '透明度', length: '长度', thickness: '粗细', offset: '中心间距', size: '大小', movement: '移动误差', firing: '射击误差', preview: '场景里试试看', decoded: '这串代码调了什么', on: '开', off: '关', generatorNote: '代码会再检查一遍，能正常读取才让你复制。', comparisonNote: '同一张地图、同一个比例，谁更顺眼一眼就能看出来。', codeHelp: '整段代码直接贴进来，别漏头漏尾，也别多带空格。', finder: '还是选不出来？', finderAction: '测一下，让我们帮你挑', faq: '大家常问',
