...
const labels = Object.freeze({
  en: Object.freeze({
    articles: Object.freeze({ copy: "How to copy a teammate's crosshair in VALORANT", notWorking: 'VALORANT crosshair code not working? Fix it fast', makeDot: 'How to make a dot crosshair in VALORANT', makeCircle: 'How to make a circle crosshair in VALORANT', movementError: 'VALORANT movement error crosshair: on or off?', firingError: 'What is firing error in VALORANT?', movementVsFiring: 'Movement error vs firing error in VALORANT', staticVsDynamic: 'Static vs dynamic crosshairs in VALORANT', dotVsCross: 'Dot vs cross crosshair in VALORANT', placement: 'VALORANT crosshair placement guide', exportCrosshair: 'How to export a VALORANT crosshair code', shareCrosshair: 'How to share a VALORANT crosshair', resetCrosshair: 'How to reset your VALORANT crosshair', saveMultiple: 'How to save multiple crosshairs in VALORANT', customColor: 'How to use a custom crosshair color in VALORANT', outlinesOnOff: 'VALORANT crosshair outlines: on or off?', centerDotOnOff: 'VALORANT center dot: on or off?', innerVsOuter: 'VALORANT inner lines vs outer lines: best settings', thickness: 'VALORANT crosshair thickness explained', gapOffset: 'VALORANT crosshair gap and offset settings' }),
