  ...
  en: {
    ...
    colors: {
      ...
      sections: [
        ...
        {
          title: 'Match color to the enemy outline',
          paragraphs: ['Your crosshair and enemy outline should remain visually separate. If both use similar colors, the center can disappear exactly when it reaches the target.', 'A practical rule is contrast: pair a yellow enemy outline with cyan or green, and a red enemy outline with green, cyan, white, or pink. Treat this as a starting point, not a universal law.'],
          bullets: ['Avoid identical crosshair and enemy-outline colors.', 'Check visibility on both the target and the map behind it.', 'Use a thin outline when one color is almost right but loses contrast.'],
        },
        {
  ...
  es: {
    ...
    colors: {
      ...
      sections: [
        ...
        { title: 'Separa la mira del contorno enemigo', paragraphs: ['Si ambos usan colores parecidos, el centro desaparece justo cuando llega al objetivo.', 'Como base, combina contorno enemigo amarillo con cian o verde, y contorno rojo con verde, cian, blanco o rosa.'], bullets: ['Evita colores idénticos.', 'Comprueba el objetivo y el fondo a la vez.', 'Añade un contorno fino si el color casi funciona.'] },
      ...
      metaTitle: 'Mejores Colores de Mira VALORANT: Cian, Verde o Blanco | AimCodes', metaDescription: 'Compara colores de mira cian, verde, blanco, amarillo, rojo y rosa en VALORANT y aprende cómo influyen el mapa, el contorno y los enemigos.',
    },
  },
  'pt-BR': {
    settings: {
    ...
    colors: {
      ...
      sections: [
        ...
        { title: 'Separe a mira do contorno inimigo', paragraphs: ['Se os dois usam cores parecidas, o centro some justamente quando chega ao alvo.', 'Como base, combine contorno inimigo amarelo com ciano ou verde, e vermelho com verde, ciano, branco ou rosa.'], bullets: ['Evite cores idênticas.', 'Confira alvo e fundo ao mesmo tempo.', 'Adicione contorno fino se a cor quase funcionar.'] },
      ...
      metaTitle: 'Melhores Cores de Mira VALORANT: Ciano, Verde ou Branco | AimCodes', metaDescription: 'Compare mira ciano, verde, branca, amarela, vermelha e rosa no VALORANT e entenda mapa, contorno e contraste com inimigos.',
    },
  },
  'zh-CN': {
    settings: {
    ...
    colors: {
      ...
      sections: [
        ...
        { title: '准星颜色要和敌人轮廓分开', paragraphs: ['两者颜色太接近时，准星会在对准敌人的瞬间消失。', '实用起点是：黄色敌人轮廓配青色或绿色准星；红色敌人轮廓配绿、青、白或粉。这个只是起点，最终还是看实际画面。'], bullets: ['避免准星和敌人轮廓使用同色。', '同时检查敌人和背后的地图。', '颜色基本合适但偶尔丢失时，加一层细轮廓。'] },
      ...
      metaTitle: '无畏契约准星颜色怎么选：青色、绿色还是白色 | AimCodes', metaDescription: '对比无畏契约青、绿、白、黄、红、粉色准星，了解地图、轮廓和敌人颜色如何影响可见度，并在真实场景中试用。',
    },
  },
}
