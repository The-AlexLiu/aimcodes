  ...
  en: {
    ...
    collections: {
      best: {
        ...
        metaTitle: '8 Best VALORANT Crosshair Codes for Ranked | AimCodes', metaDescription: 'Preview and copy 8 of the best VALORANT crosshair codes for ranked, headshots, beginners and one-taps. Test every pick on a real map scene.',
      },
      pro: {
      ...
      dot: {
        label: 'Dot crosshairs', eyebrow: 'SMALL CENTER, CLEAN SCREEN', title: 'VALORANT dot crosshair codes to copy', intro: 'Copy working dot crosshair codes, preview pure center dots on real map scenes, then try micro-cross alternatives when a single point is too easy to lose.', gridTitle: 'Dot crosshair codes to preview and copy',
        ...
        introCollectionKeys: ['dot', 'small', 'plus', 'circle'],
        settingsTitle: 'How to make a small dot crosshair', settings: ['For a pure dot, enable Center Dot and disable both Inner Lines and Outer Lines in your primary crosshair settings.', 'Start with Center Dot Opacity 1 and Thickness 2. Compare Thickness 1 and 3 at your normal resolution; these are starting values, not a universal best setting.', 'Try a thin outline on bright backgrounds. If the dot still disappears, compare a small cross rather than making the dot cover the target.', 'To import a card above, copy its full code, open Settings → Crosshair → Import Profile Code, paste, and save a separate profile.'],
        faq: [['Is a dot crosshair good in VALORANT?', 'It can be excellent for precise taps and disciplined placement. Players who spray often may prefer short lines around the center.'], ['What is a VALORANT dot crosshair code?', 'It is a profile code that imports a center-dot or dot-style setup into VALORANT. Use the copy button on any card above, then paste the full code into Import Profile Code.'], ['What dot size should I use?', 'Start small but clearly visible at your resolution. If you lose it during movement, use a thicker dot or add short inner lines.'], ['Can a dot crosshair have an outline?', 'Yes. An outline improves contrast on bright backgrounds, although a heavy outline can make the dot look larger.']],
        relatedCollectionKeys: ['small', 'oneTap', 'circle'], relatedArticleKeys: ['makeDot', 'dotVsCross'], relatedToolKeys: ['preview', 'generator'],
        metaTitle: 'VALORANT Dot Crosshair Codes & Small Dot Settings | AimCodes', metaDescription: 'Copy a VALORANT dot crosshair code or make a small dot with step-by-step settings. Compare pure dots, outlines and micro crosses on map previews.',
      },
      cute: {
    ...
    meta: {
      ...
      homeDescription: 'Find 300+ working VALORANT aim codes and crosshair codes. Preview each one on real maps, change the color, and copy a profile code into the game.',
