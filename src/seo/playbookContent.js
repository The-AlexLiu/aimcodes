...
const seo = {
  ...
  ja: {
    ...
    title: 'VALORANTマップ作戦ボード',
    intro: 'マップを選び、5人のエージェントとアビリティ、進行ルート、スパイクを配置。完成した作戦図をそのまま共有できます。',
...
const ui = {
  ...
  es: {
    boardEyebrow: 'PIZARRA TÁCTICA', boardTitle: 'Monta la ronda sobre el mapa', map: 'Mapa', toolbar: 'Herramientas', select: 'Mover', pen: 'Dibujar', arrow: 'Flecha', attacker: 'Ataque', defender: 'Defensa', spike: 'Spike', danger: 'Peligro', eraser: 'Borrar', color: 'Color de línea', rotateAbility: 'Girar habilidad', undo: 'Deshacer', redo: 'Rehacer', mapAlt: 'mapa táctico', canvasLabel: 'Pizarra táctica editable de VALORANT', emptyHint: 'Elige agente, habilidad, dibujo o flecha y usa el mapa.', quickStart: 'Empieza en 20 segundos', quickSteps: ['Elige bando y coloca los cinco agentes con sus habilidades.', 'Dibuja la ruta principal y la salida con colores distintos.', 'Exporta la imagen o copia el enlace.'], notes: 'Notas opcionales', notesPlaceholder: 'Primer contacto, utilidad, condición para cancelar…', export: 'Exportar PNG', exported: 'PNG exportado', share: 'Copiar enlace', linkCopied: 'Enlace copiado', clear: 'Limpiar mapa', localNote: 'Se guarda en este navegador. Cada mapa conserva su pizarra.', attackerShort: 'A', defenderShort: 'D', spikeShort: 'S',
  ...
  'zh-CN': {
    boardEyebrow: '地图战术板', boardTitle: '直接在地图上安排这回合', map: '选择地图', toolbar: '战术板工具', select: '移动', pen: '画路线', arrow: '画箭头', attacker: '进攻方', defender: '防守方', spike: '爆能器', danger: '危险点', eraser: '橡皮擦', color: '路线颜色', rotateAbility: '旋转技能范围', undo: '撤销', redo: '重做', mapAlt: '战术地图', canvasLabel: '可编辑的无畏契约地图战术板', emptyHint: '先选特工、技能或画线工具，再直接操作地图。', quickStart: '20 秒上手', quickSteps: ['先选攻守方，再放五名特工和技能落点。', '主攻路线和转点路线用不同颜色。', '导出图片，或者复制链接发给队友。'], notes: '补充一句回合说明', notesPlaceholder: '第一波在哪接触、技能何时交、什么情况立刻转点……', export: '导出战术图', exported: '战术图已导出', share: '复制战术链接', linkCopied: '链接已复制', clear: '清空这张地图', localNote: '自动保存在当前浏览器里，每张地图单独保存。', attackerShort: '攻', defenderShort: '守', spikeShort: '包',
