const englishGuides = {
  ...
  firingError: {
    title: 'What is firing error in VALORANT?', intro: 'Players also call this “shooting error.” Firing error is the crosshair feedback that reacts to weapon inaccuracy during taps, bursts, and sprays. Use it for practice, or turn it off when you want a fixed center.', summary: 'The firing error setting makes the crosshair react to weapon inaccuracy while you shoot. It can show when a burst has spread, but it does not control recoil and may add distracting motion.',
    sections: [
      ['What shooting or firing error shows', ['The crosshair changes as repeated shots become less accurate. The feedback follows weapon behavior; it does not cause or reduce the spread.'], ['First bullets may stay tighter.', 'Longer bursts create more inaccuracy.', 'The animation is only a visual signal.']],
    ...
    faq: [['What is shooting error in VALORANT?', 'It is another name players use for the firing error setting, which animates the crosshair as shooting becomes inaccurate.'], ['Does firing error show recoil?', 'It reflects inaccuracy, but it is not a complete recoil guide and does not replace spray practice.'], ['Should firing error be on for the Phantom?', 'It can help during practice, but many players prefer a static center in real matches.']],
    ...
    metaTitle: 'VALORANT Shooting (Firing) Error: On or Off? | AimCodes', metaDescription: 'Shooting error and firing error are the same VALORANT crosshair feedback. See what it shows and when to turn the setting on or off.',
  },
  movementVsFiring: {
    title: 'Movement error vs firing error in VALORANT', intro: 'Compare the two crosshair feedback options so you can tell whether movement or repeated shots caused the animation.', summary: 'Movement error reacts before or while you shoot if you are still moving. Firing error reacts to inaccuracy created by shooting. Enable one at a time in practice to learn the difference.',
    sections: [
