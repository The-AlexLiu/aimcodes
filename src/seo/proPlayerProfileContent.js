const base = Object.freeze({
  en: Object.freeze({
    labels: Object.freeze({ realName: 'Real name', country: 'Country', team: 'Team', role: 'Role', status: 'Status', highlight: 'Known for', crosshair: 'Crosshair to try', source: 'Player profile source', active: 'Active player', creator: 'Creator / former pro' }),
  ...
  es: Object.freeze({
    labels: Object.freeze({ realName: 'Nombre real', country: 'País', team: 'Equipo', role: 'Rol', status: 'Estado', highlight: 'Por qué destaca', crosshair: 'Mira para probar', source: 'Fuente del perfil', active: 'Jugador activo', creator: 'Creador / exprofesional' }),
  ...
  'pt-BR': Object.freeze({
    labels: Object.freeze({ realName: 'Nome', country: 'País', team: 'Time', role: 'Função', status: 'Momento', highlight: 'Destaque', crosshair: 'Mira para testar', source: 'Fonte do perfil', active: 'Em atividade', creator: 'Criador / ex-pro' }),
  ...
  'zh-CN': Object.freeze({
    labels: Object.freeze({ realName: '姓名', country: '国家/地区', team: '战队', role: '场上位置', status: '现在', highlight: '代表成绩', crosshair: '试试他的准星', source: '选手资料来源', active: '现役选手', creator: '主播 / 退役选手' }),
  ...
  ja: Object.freeze({
    labels: Object.freeze({ realName: '本名', country: '国・地域', team: 'チーム', role: 'ロール', status: '現在', highlight: '主な実績', crosshair: 'このクロスヘアを試す', source: '選手プロフィールの出典', active: '現役選手', creator: '配信者 / 元プロ' }),
