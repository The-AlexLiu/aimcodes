...
export const dictionaries = {
  en: {
    ...
    actions: { copy: 'Copy code', copied: 'Copied', copyShort: 'Copy', copiedShort: 'Copied', import: 'How to use it', clear: 'Clear search', save: 'Save crosshair' },
  ...
  es: {
    ...
    actions: { copy: 'Copiar código', copied: 'Copiado', copyShort: 'Copiar', copiedShort: 'Copiado', import: 'Cómo usarla', clear: 'Borrar búsqueda', save: 'Guardar mira' },
  ...
  'zh-CN': {
    ...
    actions: { copy: '复制代码', copied: '已复制', copyShort: '复制', copiedShort: '已复制', import: '怎么导入', clear: '清空搜索', save: '保存准星' },
    ...
    finder: {
      ...
      shareResult: '晒一下成绩', sharePreparing: '正在生成…', shareSaved: '成绩图已保存', shareShared: '已分享', shareError: '再试一次', shareTitle: '我的 AimCodes 反应段位', shareText: '我测出了{rank}，平均 {average} {unit}。你能比我快吗？', shareCardTitle: '我的反应段位', shareCardPick: '本轮推荐准星', shareCardFooter: '反应测试 · aimcodes.com',
  ...
  'pt-BR': {
    ...
    actions: { copy: 'Copiar código', copied: 'Copiado', copyShort: 'Copiar', copiedShort: 'Copiado', import: 'Como usar', clear: 'Limpar busca', save: 'Salvar mira' },
    ...
    finder: {
      ...
      shareResult: 'Compartilhar resultado', sharePreparing: 'Criando imagem…', shareSaved: 'Imagem salva', shareShared: 'Compartilhado', shareError: 'Tentar de novo', shareTitle: 'Meu elo de reação no AimCodes', shareText: 'Cheguei a {rank} com média de {average} {unit}. Consegue superar?', shareCardTitle: 'MEU ELO DE REAÇÃO', shareCardPick: 'MINHA MIRA INDICADA', shareCardFooter: 'Teste de reação · aimcodes.com',
