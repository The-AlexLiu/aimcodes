...
export const dictionaries = {
  en: {
    ...
    finder: {
      ...
      resultsTitle: 'Your reaction rank', resultsSubtitle: 'See your rank. Grab your crosshair.', testAgain: 'Go again', yourResults: 'YOUR RESULT', average: 'AVERAGE', consistency: 'CONSISTENCY', earlyClicks: 'EARLY CLICKS', roundTimes: 'ROUND TIMES',
  ...
  ja: {
    ...
    finder: {
      ...
      resultsTitle: 'あなたの反応ランク', resultsSubtitle: 'ランクを確認して、おすすめのクロスヘアを持ち帰ろう。', testAgain: 'もう一度', yourResults: '今回の結果', average: '平均', consistency: '安定度', earlyClicks: 'フライング', roundTimes: '各ラウンド',
  ...
  es: {
    ...
    finder: {
      ...
      resultsTitle: 'Tu rango de reacción', resultsSubtitle: 'Mira tu rango. Llévate tu mira.', testAgain: 'Otra vez', yourResults: 'TU RESULTADO', average: 'MEDIA', consistency: 'REGULARIDAD', earlyClicks: 'CLICS ANTES DE TIEMPO', roundTimes: 'TIEMPOS',
  ...
  'zh-CN': {
    ...
    finder: {
      ...
      resultsTitle: '你的反应段位', resultsSubtitle: '看完段位，拿走推荐准星。', testAgain: '再测一次', yourResults: '你的结果', average: '平均反应', consistency: '稳定程度', earlyClicks: '抢跑次数', roundTimes: '每轮成绩',
  ...
  'pt-BR': {
    ...
    finder: {
      ...
      resultsTitle: 'Seu elo de reação', resultsSubtitle: 'Veja seu elo. Leve sua mira.', testAgain: 'De novo', yourResults: 'SEU RESULTADO', average: 'MÉDIA', consistency: 'REGULARIDADE', earlyClicks: 'CLIQUES ADIANTADOS', roundTimes: 'TEMPOS',
