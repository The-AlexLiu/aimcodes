...
export const dictionaries = {
  en: {
    ...
    finder: {
      ...
      introTitle: 'HOW FAST ARE YOU?', introHint: 'Click to start the 3-round test', wait: 'NOT YET', waitHint: 'Click when the area turns green', clickNow: 'NOW!', readyHint: 'Click as fast as you can', tooSoon: 'TOO EARLY', tooSoonHint: 'That one doesn’t count. Get ready again.', reactionTime: '{time} ms', nextHint: 'Nice. Next round coming up…', progressLabel: '{completed} of {total} rounds done',
      ...
      shareResult: 'Create my result card', sharePreparing: 'Making card…', shareSaved: 'Image saved', shareShared: 'Shared', shareError: 'Try again', shareTitle: 'My AimCodes reaction rank', shareText: 'I hit {rank} with an average of {average} {unit}. Can you beat it?', shareCardTitle: 'MY REACTION RANK', shareCardPick: 'MY CROSSHAIR PICK', shareCardFooter: 'Reaction test · aimcodes.com',
      sharePanelEyebrow: 'YOUR CHALLENGE CARD', sharePanelTitle: 'Send this round to a teammate', sharePanelBody: 'Save the result card. Anyone who scans it can challenge your {average} {unit}.', sharePreviewAlt: 'Preview of your reaction result card', copyChallengeLink: 'Copy challenge link', challengeLinkCopied: 'Challenge link copied', shareCardChallengeTitle: 'Think you can beat me?', shareCardChallengeHint: 'Scan to challenge my {average} {unit}',
  ...
  es: {
    ...
    finder: {
      ...
      shareResult: 'Crear mi tarjeta', sharePreparing: 'Creando imagen…', shareSaved: 'Imagen guardada', shareShared: 'Compartido', shareError: 'Reintentar', shareTitle: 'Mi rango de reacción en AimCodes', shareText: 'Conseguí {rank} con una media de {average} {unit}. ¿Me superas?', shareCardTitle: 'MI RANGO DE REACCIÓN', shareCardPick: 'MI MIRA ELEGIDA', shareCardFooter: 'Prueba de reacción · aimcodes.com',
      sharePanelEyebrow: 'TU TARJETA DE RETO', sharePanelTitle: 'Manda esta ronda a tu equipo', sharePanelBody: 'Guarda la tarjeta. Quien la escanee podrá retar tus {average} {unit}.', sharePreviewAlt: 'Vista previa de tu tarjeta de reacción', copyChallengeLink: 'Copiar enlace del reto', challengeLinkCopied: 'Enlace copiado', shareCardChallengeTitle: '¿Crees que me superas?', shareCardChallengeHint: 'Escanea y reta mis {average} {unit}',
  ...
  'zh-CN': {
    ...
    finder: {
      ...
      introTitle: '来，看看你的反应有多快', introHint: '点一下开始，一共 3 轮', wait: '先别点', waitHint: '测试区域变成绿色后再点', clickNow: '就是现在！', readyHint: '快点！', tooSoon: '抢跑了', tooSoonHint: '这次不算，再来。', reactionTime: '{time} 毫秒', nextHint: '不错，下一轮马上来…', progressLabel: '完成 {completed} / {total} 轮',
      ...
      shareResult: '生成我的战绩卡', sharePreparing: '正在生成…', shareSaved: '战绩卡已保存', shareShared: '已分享', shareError: '再试一次', shareTitle: '我的 AimCodes 反应段位', shareText: '我测出了{rank}，平均 {average} {unit}。你能比我快吗？', shareCardTitle: '我的反应段位', shareCardPick: '本轮推荐准星', shareCardFooter: '反应测试 · aimcodes.com',
      sharePanelEyebrow: '你的挑战卡', sharePanelTitle: '把这局发给队友', sharePanelBody: '保存战绩卡，别人扫码就能挑战你的 {average} {unit}。', sharePreviewAlt: '反应战绩卡预览', copyChallengeLink: '复制挑战链接', challengeLinkCopied: '挑战链接已复制', shareCardChallengeTitle: '你能比我快吗？', shareCardChallengeHint: '扫码挑战我的 {average} {unit}',
  ...
  'pt-BR': {
    ...
    finder: {
      ...
      introTitle: 'VAMOS VER SEU TEMPO DE REAÇÃO', introHint: 'Clique para começar as 3 rodadas', wait: 'AINDA NÃO', waitHint: 'Clique quando a área ficar verde', clickNow: 'AGORA!', readyHint: 'Clique o mais rápido que puder', tooSoon: 'VOCÊ SE ADIANTOU', tooSoonHint: 'Essa não conta. Prepare-se de novo.', reactionTime: '{time} ms', nextHint: 'Boa. A próxima já vem…', progressLabel: '{completed} de {total} rodadas prontas',
      ...
      shareResult: 'Criar meu card', sharePreparing: 'Criando imagem…', shareSaved: 'Card salvo', shareShared: 'Compartilhado', shareError: 'Tentar de novo', shareTitle: 'Meu elo de reação no AimCodes', shareText: 'Cheguei a {rank} com média de {average} {unit}. Consegue superar?', shareCardTitle: 'MEU ELO DE REAÇÃO', shareCardPick: 'MINHA MIRA INDICADA', shareCardFooter: 'Teste de reação · aimcodes.com',
      sharePanelEyebrow: 'SEU CARD DE DESAFIO', sharePanelTitle: 'Mande esta rodada para o squad', sharePanelBody: 'Salve o card. Quem escanear poderá desafiar seus {average} {unit}.', sharePreviewAlt: 'Prévia do seu card de reação', copyChallengeLink: 'Copiar link do desafio', challengeLinkCopied: 'Link copiado', shareCardChallengeTitle: 'Acha que me supera?', shareCardChallengeHint: 'Escaneie e desafie meus {average} {unit}',
