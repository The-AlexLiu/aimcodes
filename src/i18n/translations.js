...
export const dictionaries = {
  ...
  'zh-CN': {
    ...
    finder: {
      ...
      sharePanelEyebrow: '你的挑战卡', sharePanelTitle: '队友说他反应比你快？', sharePanelBody: '把战绩卡和挑战链接发给他，给他 3 轮机会打破你的 {average} {unit}。', sharePreviewAlt: '反应战绩卡预览', copyChallengeLink: '复制挑战链接', challengeLinkCopied: '挑战链接已复制', shareCardChallengeTitle: '你能比我快吗？', shareCardChallengeHint: '来破我的 {average} {unit} · aimcodes.com',
