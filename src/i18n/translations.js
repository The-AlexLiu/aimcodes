...
export const dictionaries = {
  en: {
    ...
    finder: {
      title: 'VALORANT reaction time test', subtitle: 'Three measured rounds, one result, and a crosshair recommendation.', exit: 'Leave test', exitConfirm: 'Leave now? This unfinished run will not be saved.', round: 'ROUND {current} OF {total}', playArea: 'Reaction test area', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Your reaction performance', resultsSubtitle: 'See your pace, track progress, and try a crosshair tuned to your run.', testAgain: 'Go again', yourResults: 'YOUR RESULT', average: 'AVERAGE', consistency: 'CONSISTENCY', earlyClicks: 'EARLY CLICKS', roundTimes: 'ROUND TIMES',
      reactionRank: 'REACTION RANK', rankPlacement: 'This run: {average} {unit} · {range}', calibrationLabel: 'Your average is {average} {unit} on the reaction scale', resultActions: 'Result actions',
  ...
  ja: {
    ...
    finder: {
      title: 'VALORANT 反応速度テスト', subtitle: '3回測定して、結果とおすすめクロスヘアを表示します。', exit: 'テストを終了', exitConfirm: '終了しますか？ 未完了の記録は保存されません。', round: '{total}回中{current}回目', playArea: '反応速度テスト', millisecondsShort: 'ms',
      ...
      resultsTitle: '今回の反応パフォーマンス', resultsSubtitle: '速さと推移を確認し、今回に合うクロスヘアを試しましょう。', testAgain: 'もう一度', yourResults: '今回の結果', average: '平均', consistency: '安定度', earlyClicks: 'フライング', roundTimes: '各ラウンド',
      reactionRank: '反応ランク', rankPlacement: '今回：{average}{unit}・{range}', calibrationLabel: '反応スケール上の平均は{average}{unit}', resultActions: '結果の操作',
  ...
  es: {
    ...
    finder: {
      title: 'Prueba de reacción de VALORANT', subtitle: 'Tres rondas medidas, un resultado y una mira recomendada.', exit: 'Salir', exitConfirm: '¿Salir ahora? Esta prueba sin terminar no se guardará.', round: 'RONDA {current} DE {total}', playArea: 'Zona de prueba de reacción', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Tu rendimiento de reacción', resultsSubtitle: 'Revisa tu ritmo, sigue tu progreso y prueba una mira adaptada a tu resultado.', testAgain: 'Otra vez', yourResults: 'TU RESULTADO', average: 'MEDIA', consistency: 'REGULARIDAD', earlyClicks: 'CLICS ANTES DE TIEMPO', roundTimes: 'TIEMPOS',
      reactionRank: 'RANGO DE REACCIÓN', rankPlacement: 'Esta ronda: {average} {unit} · {range}', calibrationLabel: 'Tu media es {average} {unit} en la escala de reacción', resultActions: 'Acciones del resultado',
      ...
      shareResult: 'Compartir reto', sharePreparing: 'Preparando tarjeta…', shareSaved: 'Tarjeta guardada', shareShared: 'Reto enviado', shareError: 'Reintentar', shareTitle: 'Mi rango de reacción en AimCodes', shareText: 'Mi media fue de {average} {unit} y llegué a {rank}. ¿Me superas?', shareNoLogin: 'Sin iniciar sesión', shareThreeRounds: '3 rondas · unos 10 segundos', shareCardTitle: 'MI RANGO DE REACCIÓN', shareCardPick: 'MI MIRA ELEGIDA', shareCardFooter: 'Prueba de reacción · aimcodes.com',
  ...
  'zh-CN': {
    ...
    finder: {
      title: '无畏契约反应速度测试', subtitle: '测量 3 轮反应，查看结果并获得一款准星推荐。', exit: '退出', exitConfirm: '现在退出吗？未完成的本次测试不会保存。', round: '第 {current} 轮，共 {total} 轮', playArea: '反应测试区域', millisecondsShort: '毫秒',
      ...
      resultsTitle: '你的反应表现', resultsSubtitle: '看清速度、记录进步，再试一款更适合这次表现的准星。', testAgain: '再测一次', yourResults: '你的结果', average: '平均反应', consistency: '稳定程度', earlyClicks: '抢跑次数', roundTimes: '每轮成绩',
      reactionRank: '反应段位', rankPlacement: '本轮 {average} {unit} · {range}', calibrationLabel: '你的平均反应为 {average} {unit}', resultActions: '成绩操作',
      ...
      shareResult: '分享挑战', sharePreparing: '正在准备战绩卡…', shareSaved: '战绩卡已保存', shareShared: '挑战已发出', shareError: '再试一次', shareTitle: '我的 AimCodes 反应段位', shareText: '我三轮平均 {average} {unit}，打到了{rank}。你能比我快吗？', shareNoLogin: '不用登录', shareThreeRounds: '3 轮 · 约 10 秒', shareCardTitle: '我的反应段位', shareCardPick: '本轮推荐准星', shareCardFooter: '反应测试 · aimcodes.com',
  ...
  'pt-BR': {
    ...
    finder: {
      title: 'Teste de reação do VALORANT', subtitle: 'Três rodadas medidas, um resultado e uma mira recomendada.', exit: 'Sair', exitConfirm: 'Sair agora? Este teste incompleto não será salvo.', round: 'RODADA {current} DE {total}', playArea: 'Área do teste de reação', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Seu desempenho de reação', resultsSubtitle: 'Veja seu ritmo, acompanhe o progresso e teste uma mira ajustada ao resultado.', testAgain: 'De novo', yourResults: 'SEU RESULTADO', average: 'MÉDIA', consistency: 'REGULARIDADE', earlyClicks: 'CLIQUES ADIANTADOS', roundTimes: 'TEMPOS',
      reactionRank: 'ELO DE REAÇÃO', rankPlacement: 'Nesta rodada: {average} {unit} · {range}', calibrationLabel: 'Sua média é {average} {unit} na escala de reação', resultActions: 'Ações do resultado',
