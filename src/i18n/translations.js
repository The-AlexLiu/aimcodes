...
export const dictionaries = {
  en: {
    ...
    finder: {
      title: 'VALORANT reaction time test', titleLead: 'VALORANT reaction', titleTail: 'time test', subtitle: 'Three rounds to measure your reaction time.', exit: 'Leave test', exitConfirm: 'Leave now? This unfinished run will not be saved.', round: 'ROUND {current} OF {total}', playArea: 'Reaction test area', millisecondsShort: 'ms',
      introTitle: 'HOW FAST ARE YOU?', introHint: 'Click to start the 3-round test', wait: 'NOT YET', waitHint: 'Click when the area turns green', clickNow: 'NOW!', readyHint: 'Click as fast as you can', tooSoon: 'TOO EARLY', tooSoonHint: 'That one doesn’t count. Get ready again.', implausible: 'TOO FAST TO VERIFY', implausibleHint: 'Under 100 ms looks like anticipation, so this round will restart.', tooSlow: 'TOO SLOW', tooSlowHint: 'That round expired. Get ready and try again.', reactionTime: '{time} ms', nextHint: 'Nice. Next round coming up…', progressLabel: '{completed} of {total} rounds done',
      legendReady: 'Green means go', legendEarly: 'Red means too early', deviceNote: 'Your screen, mouse, and device can all affect the result.', testBriefLabel: 'How the reaction test works', testDuration: '3 rounds · about 10 seconds', runDetailsTitle: 'Your run, at a glance', best: 'BEST',
      resultsTitle: 'Your reaction performance', resultsSubtitle: 'Your score, round times, and next target.', testAgain: 'Go again', yourResults: 'YOUR RESULT', average: 'AVERAGE', consistency: 'CONSISTENCY', earlyClicks: 'EARLY CLICKS', roundTimes: 'ROUND TIMES',
      reactionRank: 'REACTION RANK', rankPlacement: 'Scored result: {average} {unit} · {range}', calibrationLabel: 'Your scored result is {average} {unit} on the reaction scale', adjustedResult: '{count} isolated pause excluded; the remaining rounds set your score.', notCounted: 'not counted', resultActions: 'Result actions',
      ...
      shareResult: 'Share challenge', sharePreparing: 'Preparing card…', shareSaved: 'Result card saved', shareShared: 'Challenge sent', shareError: 'Try again', shareTitle: 'My AimCodes reaction rank', shareText: 'I scored {average} {unit} and reached {rank}. Can you beat me?', shareNoLogin: 'No sign-in required', shareThreeRounds: '3 rounds · about 10 seconds', shareCardTitle: 'MY REACTION RANK', shareCardPick: 'MY CROSSHAIR PICK', shareCardFooter: 'Reaction test · aimcodes.com',
      copyChallengeLink: 'Copy challenge link', challengeLinkCopied: 'Challenge link copied',
      ...
      copyHelp: 'The color is already in the code. Copy it and import it in VALORANT.', rankRanges: 'REACTION RANK RULES', rankRangesHint: 'Faster ranks come first. Your screen and mouse can change the score.', yourTier: 'YOU', backExplore: 'Back to crosshairs',
    },
  },
  ja: {
    ...
    finder: {
      title: 'VALORANT 反応速度テスト', titleLead: 'VALORANT', titleTail: '反応速度テスト', subtitle: '3回の測定で反応速度を確認します。', exit: 'テストを終了', exitConfirm: '終了しますか？ 未完了の記録は保存されません。', round: '{total}回中{current}回目', playArea: '反応速度テスト', millisecondsShort: 'ms',
      introTitle: '反応速度を測ってみよう', introHint: 'クリックして3回のテストを開始', wait: 'まだ！', waitHint: 'エリアが緑になったらクリック', clickNow: '今！', readyHint: 'できるだけ速くクリック', tooSoon: 'フライング', tooSoonHint: 'この回はノーカウント。もう一度構えよう。', implausible: '速すぎて判定できません', implausibleHint: '100ms未満は先読みの可能性があるため、この回をやり直します。', tooSlow: '遅すぎます', tooSlowHint: '時間切れです。もう一度試そう。', reactionTime: '{time} ms', nextHint: 'いい感じ。次のラウンドへ…', progressLabel: '{total}回中{completed}回完了',
      legendReady: '緑になったらクリック', legendEarly: '赤はフライング', deviceNote: '画面・マウス・端末によって結果が変わることがあります。', testBriefLabel: '反応テストのルール', testDuration: '3 ラウンド · 約 10 秒', runDetailsTitle: '今回の記録', best: '最速',
      resultsTitle: '今回の反応パフォーマンス', resultsSubtitle: '今回の記録、各ラウンド、次の目標を確認。', testAgain: 'もう一度', yourResults: '今回の結果', average: '平均', consistency: '安定度', earlyClicks: 'フライング', roundTimes: '各ラウンド',
      reactionRank: '反応ランク', rankPlacement: '今回の記録：{average}{unit}・{range}', calibrationLabel: '反応スケール上の記録は{average}{unit}', adjustedResult: '単独の停止{count}回を除外し、残りのラウンドで記録しました。', notCounted: '対象外', resultActions: '結果の操作',
      ...
      shareResult: '挑戦を共有', sharePreparing: 'カードを準備中…', shareSaved: '結果カードを保存しました', shareShared: '挑戦を送りました', shareError: 'もう一度試す', shareTitle: 'AimCodes反応ランク', shareText: '記録は{average}{unit}で{rank}でした。超えられる？', shareNoLogin: 'ログイン不要', shareThreeRounds: '3ラウンド・約10秒', shareCardTitle: '私の反応ランク', shareCardPick: 'おすすめクロスヘア', shareCardFooter: '反応速度テスト・aimcodes.com',
      copyChallengeLink: '挑戦リンクをコピー', challengeLinkCopied: '挑戦リンクをコピーしました',
      ...
      copyHelp: '選んだ色はコードに反映済みです。コピーしてVALORANTにインポートしてください。', rankRanges: 'ランク表', rankRangesHint: '速いランクから順に表示。画面やマウスでも記録は変わります。', yourTier: 'あなた', backExplore: 'クロスヘア一覧へ',
    },
  },
  es: {
    ...
    finder: {
      title: 'Prueba de reacción de VALORANT', titleLead: 'Prueba de reacción', titleTail: 'de VALORANT', subtitle: 'Tres rondas para medir tu tiempo de reacción.', exit: 'Salir', exitConfirm: '¿Salir ahora? Esta prueba sin terminar no se guardará.', round: 'RONDA {current} DE {total}', playArea: 'Zona de prueba de reacción', millisecondsShort: 'ms',
      introTitle: 'A VER QUÉ TAN RÁPIDO ERES', introHint: 'Haz clic para empezar las 3 rondas', wait: 'TODAVÍA NO', waitHint: 'Haz clic cuando la zona se ponga verde', clickNow: '¡AHORA!', readyHint: 'Haz clic lo más rápido que puedas', tooSoon: 'TE ADELANTASTE', tooSoonHint: 'Esa no cuenta. Prepárate otra vez.', implausible: 'DEMASIADO RÁPIDO PARA VALIDAR', implausibleHint: 'Menos de 100 ms parece anticipación; repetiremos esta ronda.', tooSlow: 'DEMASIADO TARDE', tooSlowHint: 'Esa ronda caducó. Prepárate y vuelve a intentarlo.', reactionTime: '{time} ms', nextHint: 'Bien. La siguiente ya viene…', progressLabel: '{completed} de {total} rondas listas',
      legendReady: 'Verde: haz clic', legendEarly: 'Rojo: te adelantaste', deviceNote: 'La pantalla, el ratón y el dispositivo pueden cambiar el resultado.', testBriefLabel: 'Cómo funciona la prueba', testDuration: '3 rondas · unos 10 segundos', runDetailsTitle: 'Tu partida de un vistazo', best: 'MEJOR',
      resultsTitle: 'Tu rendimiento de reacción', resultsSubtitle: 'Tu resultado, cada ronda y tu próximo objetivo.', testAgain: 'Otra vez', yourResults: 'TU RESULTADO', average: 'MEDIA', consistency: 'REGULARIDAD', earlyClicks: 'CLICS ANTES DE TIEMPO', roundTimes: 'TIEMPOS',
      reactionRank: 'RANGO DE REACCIÓN', rankPlacement: 'Resultado puntuado: {average} {unit} · {range}', calibrationLabel: 'Tu resultado es {average} {unit} en la escala de reacción', adjustedResult: 'Se excluyó {count} pausa aislada; las rondas restantes fijaron el resultado.', notCounted: 'no cuenta', resultActions: 'Acciones del resultado',
      ...
      shareResult: 'Compartir reto', sharePreparing: 'Preparando tarjeta…', shareSaved: 'Tarjeta guardada', shareShared: 'Reto enviado', shareError: 'Reintentar', shareTitle: 'Mi rango de reacción en AimCodes', shareText: 'Marqué {average} {unit} y llegué a {rank}. ¿Me superas?', shareNoLogin: 'Sin iniciar sesión', shareThreeRounds: '3 rondas · unos 10 segundos', shareCardTitle: 'MI RANGO DE REACCIÓN', shareCardPick: 'MI MIRA ELEGIDA', shareCardFooter: 'Prueba de reacción · aimcodes.com',
      copyChallengeLink: 'Copiar enlace del reto', challengeLinkCopied: 'Enlace copiado',
      ...
      copyHelp: 'El color ya va dentro del código. Cópialo e impórtalo en VALORANT.', rankRanges: 'REGLAS DE RANGO', rankRangesHint: 'Los rangos más rápidos aparecen primero. Tu pantalla y ratón también influyen.', yourTier: 'TÚ', backExplore: 'Volver a las miras',
    },
  },
  'zh-CN': {
    ...
    finder: {
      title: '无畏契约反应速度测试', titleLead: '无畏契约', titleTail: '反应速度测试', subtitle: '完成 3 轮点击，测测你的反应速度。', exit: '退出', exitConfirm: '现在退出吗？未完成的本次测试不会保存。', round: '第 {current} 轮，共 {total} 轮', playArea: '反应测试区域', millisecondsShort: '毫秒',
      introTitle: '来，看看你的反应有多快', introHint: '点一下开始，一共 3 轮', wait: '先别点', waitHint: '测试区域变成绿色后再点', clickNow: '就是现在！', readyHint: '快点！', tooSoon: '抢跑了', tooSoonHint: '这次不算，再来。', implausible: '快得无法确认', implausibleHint: '低于 100 毫秒通常是提前预判，本轮重新测试。', tooSlow: '这轮超时了', tooSlowHint: '这次不计成绩，马上重来。', reactionTime: '{time} 毫秒', nextHint: '不错，下一轮马上来…', progressLabel: '完成 {completed} / {total} 轮',
      legendReady: '测试区域变绿就点', legendEarly: '变红说明抢跑了', deviceNote: '屏幕、鼠标和设备性能都会影响成绩。', testBriefLabel: '反应测试规则', testDuration: '3 轮 · 约 10 秒', runDetailsTitle: '本次成绩明细', best: '最快一轮',
      resultsTitle: '你的反应表现', resultsSubtitle: '看看本次成绩、每轮表现和下一个目标。', testAgain: '再测一次', yourResults: '你的结果', average: '计分成绩', consistency: '稳定程度', earlyClicks: '抢跑次数', roundTimes: '每轮成绩',
      reactionRank: '反应段位', rankPlacement: '本轮计分 {average} {unit} · {range}', calibrationLabel: '你的计分成绩为 {average} {unit}', adjustedResult: '已排除 {count} 次异常停顿，按其余两轮计分。', notCounted: '未计入', resultActions: '成绩操作',
      ...
      shareResult: '分享挑战', sharePreparing: '正在准备战绩卡…', shareSaved: '战绩卡已保存', shareShared: '挑战已发出', shareError: '再试一次', shareTitle: '我的 AimCodes 反应段位', shareText: '我本轮计分 {average} {unit}，打到了{rank}。你能比我快吗？', shareNoLogin: '不用登录', shareThreeRounds: '3 轮 · 约 10 秒', shareCardTitle: '我的反应段位', shareCardPick: '本轮推荐准星', shareCardFooter: '反应测试 · aimcodes.com',
      copyChallengeLink: '复制挑战链接', challengeLinkCopied: '挑战链接已复制',
      ...
      copyHelp: '颜色已经写进代码，复制后直接导入游戏就行。', rankRanges: '反应段位规则', rankRangesHint: '按反应从快到慢排列；屏幕和鼠标也会影响成绩。', yourTier: '你', backExplore: '返回找准星',
    },
  },
  'pt-BR': {
    ...
    finder: {
      title: 'Teste de reação do VALORANT', titleLead: 'Teste de reação', titleTail: 'do VALORANT', subtitle: 'Três rodadas para medir seu tempo de reação.', exit: 'Sair', exitConfirm: 'Sair agora? Este teste incompleto não será salvo.', round: 'RODADA {current} DE {total}', playArea: 'Área do teste de reação', millisecondsShort: 'ms',
      introTitle: 'VAMOS VER SEU TEMPO DE REAÇÃO', introHint: 'Clique para começar as 3 rodadas', wait: 'AINDA NÃO', waitHint: 'Clique quando a área ficar verde', clickNow: 'AGORA!', readyHint: 'Clique o mais rápido que puder', tooSoon: 'VOCÊ SE ADIANTOU', tooSoonHint: 'Essa não conta. Prepare-se de novo.', implausible: 'RÁPIDO DEMAIS PARA VALIDAR', implausibleHint: 'Menos de 100 ms parece antecipação; vamos repetir a rodada.', tooSlow: 'DEMOROU DEMAIS', tooSlowHint: 'Essa rodada expirou. Prepare-se e tente de novo.', reactionTime: '{time} ms', nextHint: 'Boa. A próxima já vem…', progressLabel: '{completed} de {total} rodadas prontas',
      legendReady: 'Verde: clique', legendEarly: 'Vermelho: foi cedo demais', deviceNote: 'Sua tela, mouse e aparelho podem mudar o resultado.', testBriefLabel: 'Como funciona o teste', testDuration: '3 rodadas · cerca de 10 segundos', runDetailsTitle: 'Seu resultado em detalhes', best: 'MELHOR',
      resultsTitle: 'Seu desempenho de reação', resultsSubtitle: 'Seu resultado, cada rodada e o próximo objetivo.', testAgain: 'De novo', yourResults: 'SEU RESULTADO', average: 'MÉDIA', consistency: 'REGULARIDADE', earlyClicks: 'CLIQUES ADIANTADOS', roundTimes: 'TEMPOS',
      reactionRank: 'ELO DE REAÇÃO', rankPlacement: 'Resultado pontuado: {average} {unit} · {range}', calibrationLabel: 'Seu resultado é {average} {unit} na escala de reação', adjustedResult: '{count} pausa isolada foi excluída; as outras rodadas definiram o resultado.', notCounted: 'não conta', resultActions: 'Ações do resultado',
      ...
      shareResult: 'Compartilhar desafio', sharePreparing: 'Preparando card…', shareSaved: 'Card de resultado salvo', shareShared: 'Desafio enviado', shareError: 'Tentar de novo', shareTitle: 'Meu elo de reação no AimCodes', shareText: 'Meu resultado foi {average} {unit} e cheguei a {rank}. Consegue superar?', shareNoLogin: 'Sem login', shareThreeRounds: '3 rodadas · cerca de 10 segundos', shareCardTitle: 'MEU ELO DE REAÇÃO', shareCardPick: 'MINHA MIRA INDICADA', shareCardFooter: 'Teste de reação · aimcodes.com',
      copyChallengeLink: 'Copiar link do desafio', challengeLinkCopied: 'Link copiado',
      ...
      copyHelp: 'A cor já está no código. Copie e importe no VALORANT.', rankRanges: 'REGRAS DOS ELOS', rankRangesHint: 'Os elos mais rápidos aparecem primeiro. Sua tela e mouse também influenciam.', yourTier: 'VOCÊ', backExplore: 'Voltar para as miras',
    },
  },
}
