...
export const dictionaries = {
  en: {
    ...
    finder: {
      title: 'VALORANT reaction time test', titleLead: 'VALORANT reaction', titleTail: 'time test', subtitle: 'Three measured rounds reveal your reaction rank and aim style.', exit: 'Leave test', exitConfirm: 'Leave now? This unfinished run will not be saved.', round: 'ROUND {current} OF {total}', playArea: 'Reaction test area', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Your reaction performance', resultsSubtitle: 'See your pace, aim style, and next training target.', testAgain: 'Go again', yourResults: 'YOUR RESULT', average: 'AVERAGE', consistency: 'CONSISTENCY', earlyClicks: 'EARLY CLICKS', roundTimes: 'ROUND TIMES',
  ...
  ja: {
    ...
    finder: {
      title: 'VALORANT 反応速度テスト', titleLead: 'VALORANT', titleTail: '反応速度テスト', subtitle: '3回の測定で反応ランクとエイム傾向を確認します。', exit: 'テストを終了', exitConfirm: '終了しますか？ 未完了の記録は保存されません。', round: '{total}回中{current}回目', playArea: '反応速度テスト', millisecondsShort: 'ms',
      ...
      resultsTitle: '今回の反応パフォーマンス', resultsSubtitle: '速さ、エイム傾向、次の目標を確認しましょう。', testAgain: 'もう一度', yourResults: '今回の結果', average: '平均', consistency: '安定度', earlyClicks: 'フライング', roundTimes: '各ラウンド',
  ...
  es: {
    ...
    finder: {
      title: 'Prueba de reacción de VALORANT', titleLead: 'Prueba de reacción', titleTail: 'de VALORANT', subtitle: 'Tres rondas revelan tu rango de reacción y estilo de puntería.', exit: 'Salir', exitConfirm: '¿Salir ahora? Esta prueba sin terminar no se guardará.', round: 'RONDA {current} DE {total}', playArea: 'Zona de prueba de reacción', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Tu rendimiento de reacción', resultsSubtitle: 'Revisa tu ritmo, estilo de puntería y próximo objetivo.', testAgain: 'Otra vez', yourResults: 'TU RESULTADO', average: 'MEDIA', consistency: 'REGULARIDAD', earlyClicks: 'CLICS ANTES DE TIEMPO', roundTimes: 'TIEMPOS',
  ...
  'zh-CN': {
    ...
    finder: {
      title: '无畏契约反应速度测试', titleLead: '无畏契约', titleTail: '反应速度测试', subtitle: '测量 3 轮反应，看看你的反应段位和瞄准风格。', exit: '退出', exitConfirm: '现在退出吗？未完成的本次测试不会保存。', round: '第 {current} 轮，共 {total} 轮', playArea: '反应测试区域', millisecondsShort: '毫秒',
      ...
      resultsTitle: '你的反应表现', resultsSubtitle: '看清速度、瞄准风格和下一阶段目标。', testAgain: '再测一次', yourResults: '你的结果', average: '计分成绩', consistency: '稳定程度', earlyClicks: '抢跑次数', roundTimes: '每轮成绩',
  ...
  'pt-BR': {
    ...
    finder: {
      title: 'Teste de reação do VALORANT', titleLead: 'Teste de reação', titleTail: 'do VALORANT', subtitle: 'Três rodadas revelam seu elo de reação e estilo de mira.', exit: 'Sair', exitConfirm: 'Sair agora? Este teste incompleto não será salvo.', round: 'RODADA {current} DE {total}', playArea: 'Área do teste de reação', millisecondsShort: 'ms',
      ...
      resultsTitle: 'Seu desempenho de reação', resultsSubtitle: 'Veja seu ritmo, estilo de mira e próximo objetivo.', testAgain: 'De novo', yourResults: 'SEU RESULTADO', average: 'MÉDIA', consistency: 'REGULARIDADE', earlyClicks: 'CLIQUES ADIANTADOS', roundTimes: 'TEMPOS',
